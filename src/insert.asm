...
checkKeyboardStatus:
	...
	checkKey key.tab, 		.tab 			;Comprueba si se presiono tab
	checkKey key.backspace, .backspace 		;Comprueba si se presiono backspace
	checkKey key.enter, 	.enter 			;Comprueba si se presiono enter

	checkKey key.esc, .exit					;Comprueba si se presiono escape para salir del modo
	jmp .end
